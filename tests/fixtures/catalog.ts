...
export function makeCatalog(): Catalog {
  return {
    ...
    addons: [
      ...
      // Subscribing to GEO monitoring covers its one-time setup at no cost.
      addon('geomon', {
        category_id: 'seogeo_bundles',
        billing: 'monthly',
        price_now: 149,
        ai_bundle_member: true,
        bundle_members: ['geosetup'],
      }),
      ...
      addon('seosetup', { category_id: 'seogeo_setup', price_now: 420, price_later: 630 }),
      ...
      addon('geosetup', { category_id: 'seogeo_setup', price_now: 420, price_later: 630 }),
      addon('seogeosetup', {
