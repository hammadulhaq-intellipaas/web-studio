...
export const ENTITIES: Record<string, EntityDef> = {
  ...
  support_plans: {
    ...
    fields: [
      ...
      de('name_en', 'Name (EN)'),
      num('price_monthly', '€/mo.'),
      num('included_hours', 'Hours included / mo.'),
      de('sla_de', 'Response time (DE)'),
      de('sla_en', 'Response time (EN)'),
      de('channels_de', 'Channels (DE)'),
      de('channels_en', 'Channels (EN)'),
      { key: 'recommended', label: 'Recommended', type: 'boolean' },
      { key: 'desc_de', label: 'Description (DE) — fallback', type: 'textarea', full: true },
      { key: 'desc_en', label: 'Description (EN) — fallback', type: 'textarea', full: true },
      num('sort', 'Sort'),
    ],
  },
  personas: {
