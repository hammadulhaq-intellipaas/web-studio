...
export const examples: OnbExample[] = [
  {
    ...
    answers: {
      ...
      visitor_actions: { book: 'most', call: 'very', visit: 'some', enquiry: 'some', buy: 'not', signup: 'not' },
      tone_scale: 3,
      personality_scale: 2,
      references: [
        {
      ...
      booking_account_holder: 'Lena Hartmann',
      maps_link: 'https://maps.app.goo.gl/abc123',
      reviews_link: null,
      legal_pages: 'reuse',
