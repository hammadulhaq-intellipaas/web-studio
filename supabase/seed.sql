...
('seosetup',    'seogeo_setup', 'SEO-Onpage-Setup (Meta, Sitemap, Search Console)', 'SEO on-page setup (meta, sitemap, Search Console)', null, null, 'once', 450, 690, null, null, '{}', false, false, false, null, null, false, 10, null, null),
('geosetup',    'seogeo_setup', 'GEO-Basis-Setup (Schema.org, AI-Sichtbarkeit)', 'GEO basic setup (Schema.org, AI visibility)', null, null, 'once', 390, 590, null, null, '{}', false, false, false, null, null, false, 20, null, null),
('seogeosetup', 'seogeo_setup', 'SEO + GEO Setup Bundle', 'SEO + GEO setup bundle', 'Gefunden bei Google und bei ChatGPT.', 'Found on Google and on ChatGPT.', 'once', 765, 1090, null, null, '{}', false, false, false, 'Bestes Preis-Leistung', 'Best value', true, 30, null, null),
('localseo',    'seogeo_setup', 'Lokale SEO-Einrichtung (Google Business Profile)', 'Local SEO setup (Google Business Profile)', null, null, 'once', 350, 550, null, null, '{}', false, false, false, null, null, false, 40, 'Erstellt/optimiert Ihr Google Unternehmensprofil, damit Sie in der lokalen Suche und bei Maps erscheinen.', 'Creates/optimizes your Google Business Profile so you appear in local search and Maps.'),
('citation',    'seogeo_setup', 'Lokale Zitationsbereinigung (NAP, Verzeichnisse)', 'Local citation cleanup (NAP, directories)', null, null, 'once', 250, 390, null, null, '{}', false, false, false, null, null, false, 50, 'Gleicht Name/Adresse/Telefon über Verzeichnisse hinweg ab, um lokales Vertrauen zu stärken.', 'Aligns your Name/Address/Phone across directories to boost local trust.'),
-- marketing › SEO & GEO — laufend
('seostarter',  'seogeo_mon', 'SEO Starter — Keyword-Monitoring, Reports, 1 Artikel/Mon.', 'SEO Starter — keyword monitoring, reports, 1 article/mo.', null, null, 'monthly', 269, null, null, null, '{}', false, false, false, null, null, false, 10, 'Monatliches Keyword-Monitoring, ein Report und 1 SEO-Artikel/Monat — laufendes Marketing über den einmaligen Build hinaus.', 'Monthly keyword monitoring, a report and 1 SEO article/month — ongoing marketing beyond the one-time build.'),
('seopro',      'seogeo_mon', 'SEO Pro — + 2 Artikel/Mon., Wettbewerbs-Monitoring, Call', 'SEO Pro — + 2 articles/mo., competitor monitoring, call', null, null, 'monthly', 399, null, null, null, '{}', false, false, false, null, null, false, 20, 'Ergänzt einen 2. Artikel/Monat, Wettbewerbs-Monitoring und einen monatlichen Call zusätzlich zu Starter.', 'Adds a 2nd article/month, competitor monitoring and a monthly call on top of Starter.'),
('geomon',      'seogeo_mon', 'GEO Monitoring — AI-Sichtbarkeit (ChatGPT, Perplexity, Gemini)', 'GEO monitoring — AI visibility (ChatGPT, Perplexity, Gemini)', null, null, 'monthly', 149, null, null, null, '{}', false, false, true, null, null, false, 30, 'Verfolgt Ihre Sichtbarkeit in KI-Antworten (ChatGPT, Perplexity, Gemini).', 'Tracks your visibility in AI answers (ChatGPT, Perplexity, Gemini).'),
('seogeokombi', 'seogeo_mon', 'SEO + GEO Kombi (~17 % Rabatt)', 'SEO + GEO combo (~17% off)', null, null, 'monthly', 349, null, null, null, '{}', false, false, false, 'Bestes Preis-Leistung', 'Best value', true, 40, 'Bündelt SEO- und GEO-Monitoring zu ca. 17 % Rabatt gegenüber Einzelbuchung.', 'Bundles SEO and GEO monitoring at ~17% off versus separately.'),
