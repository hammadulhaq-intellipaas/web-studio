...
('seosetup',    'seogeo_setup', 'SEO-Onpage-Setup (Meta, Sitemap, Search Console)', 'SEO on-page setup (meta, sitemap, Search Console)', 'Kostenlos bei SEO Starter, SEO Pro oder dem SEO + GEO Kombi.', 'Free with SEO Starter, SEO Pro or the SEO + GEO combo.', 'once', 360, 540, null, null, '{}', false, false, false, null, null, false, 10, 'Richtet Ihre technischen SEO-Grundlagen ein — Meta-Tags, Sitemap, Google Search Console — einmalig.', 'Sets up your technical SEO foundations — meta tags, sitemap, Google Search Console — one-time.'),
('geosetup',    'seogeo_setup', 'GEO-Basis-Setup (Schema.org, AI-Sichtbarkeit)', 'GEO basic setup (Schema.org, AI visibility)', 'Kostenlos bei GEO Monitoring oder dem SEO + GEO Kombi.', 'Free with GEO monitoring or the SEO + GEO combo.', 'once', 360, 540, null, null, '{}', false, false, false, null, null, false, 20, 'Optimiert Ihre Sichtbarkeit in KI-Assistenten über strukturierte Schema.org-Daten — einmalig.', 'Optimizes your visibility in AI assistants through Schema.org structured data — one-time.'),
('seogeosetup', 'seogeo_setup', 'SEO + GEO Setup Bundle', 'SEO + GEO setup bundle', 'Einmalige Einrichtungsgebühr — kostenlos beim SEO + GEO Kombi.', 'One-time setup fee — free with the SEO + GEO combo.', 'once', 685, 1030, null, null, '{}', false, false, false, 'Bestes Preis-Leistung', 'Best value', true, 30, 'Bündelt SEO- und GEO-Setup in einer einmaligen Gebühr — günstiger als beides einzeln, gefunden bei Google und bei ChatGPT.', 'Bundles the SEO and GEO setup in one one-time fee — cheaper than booking them separately, and found on both Google and ChatGPT.'),
